...
urlpatterns = [
    ...
    path('postponed-tasks/',views.postponed_tasks, name='postponed-tasks'),
    path('late-tasks/',views.late_tasks, name='late-tasks'),
    path('pending-tasks/',views.pending_tasks, name='pending-tasks'),
    path('api/get_updates/', views.get_updates, name='get-updates'),
